...
public class Media implements Comparable<Media> {
     ...
     *
     * @see org.videolan.vlc2.util.Util#getValue(String, int)
     *
     ...
     * due to lazy-loading.
     *
     * Use {@link org.videolan.vlc2.util.Bitmap#getPictureFromCache(Media)} instead.
     *
     ...
     *
     * In VLC for Android, use {@link org.videolan.vlc2.MediaDatabase#setPicture(Media, Bitmap)} instead.
     *
     * @param p
     */
